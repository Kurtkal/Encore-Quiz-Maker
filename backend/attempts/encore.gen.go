...
type Interface interface {
	SubmitQuiz(ctx context.Context, id int64, p *SubmitQuizRequest) (*QuizResultResponse, error)

	GetLatestResult(ctx context.Context, id int64) (*QuizResultResponse, error)
}
